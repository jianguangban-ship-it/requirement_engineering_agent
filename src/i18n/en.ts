export default {
  ...
  form: {
    ...
    projectNameDesign: 'Library Name',
    assignee: 'Assignee',
    assigneeDesign: 'Author',
    members: 'members',
    ...
    results: 'results',
    taskType: 'Task Type',
    taskTypeDesign: 'Item Type',
    storyPoints: 'Story Points',
    aiWillVerify: 'AI will verify',
    taskSummary: 'Task Summary',
    taskSummaryDesign: 'Requirement Summary',
    fivePartInput: 'Five-Part Structured Input',
    vehicle: 'Vehicle',
    vehicleDesign: 'Product',
    product: 'Product',
    productDesign: 'Classification',
    layer: 'Layer',
    component: 'Component',
    componentPlaceholder: 'Component name',
    taskDetail: 'Task Detail',
    taskDetailDesign: 'Requirement Title',
  ...
  panel: {
    ...
    aiAgentResponseDesign: 'Requirement Decomposition',
  ...
  dev: {
    ...
    model: 'Model',
    coachSkill: 'Design Skill',
    decomposeSkill: 'Decomposition Skill',
    taskCoachSkill: 'Task Skill',
    designSystemPrompt: 'Design System Prompt',
    taskSystemPrompt: 'Task System Prompt',
  ...
  coach: {
    ...
    emptyHintDesign: 'Write ASPICE-compliant requirements with AI guidance',
    emptySubHintDesign: 'Describe your requirement — the coach follows ASPICE SYS/SWE processes and ISO 26262 standards',
  ...
  modal: {
    ...
    confirmTitleDesign: 'Confirm Requirement Creation',
    confirmHint: 'Review the payload below before creating the JIRA ticket.',
    confirmHintDesign: 'Review the payload below before creating the requirement item.',
    cancel: 'Cancel',
