export default {
  ...
  dev: {
    ...
    model: '模型',
    coachSkill: '设计提示词',
    decomposeSkill: '需求分解提示词',
    taskCoachSkill: '任务提示词',
    designSystemPrompt: '设计系统提示词',
    taskSystemPrompt: '任务系统提示词',
    analyzeSkill: '分析提示词',
  ...
  coach: {
    ...
    emptyHintDesign: '借助 AI 辅导，撰写符合 ASPICE 规范的需求',
    emptySubHintDesign: '描述您的需求内容 — AI 教练遵循 ASPICE SYS/SWE 流程与 ISO 26262 标准',
  ...
  modal: {
    ...
    confirmTitleDesign: '确认创建需求条目',
    confirmHint: '请检查以下 Payload 后再创建工单。',
    confirmHintDesign: '请检查以下 Payload 后再创建需求条目。',
    cancel: '取消',
    confirm: '创建工单'
  },
  toast: {
